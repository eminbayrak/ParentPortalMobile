...
namespace ParPorApp.Views
{
    ...
    public partial class GroupsPage : ContentPage
    {
        ...
        public GroupsPage()
        {
            ...
            {
                new Newsfeed{ Name = "Coach Ashley", ImageUrl = "http://randomuser.me/api/portraits/med/women/19.jpg", GameIcon = "volleyball.png", Description = "Game", PostDate = "03/12/2018 09:12AM", EventDate = "03/18/2018 07:00PM", HomeTeamLogo = "milford.png", AwayTeamLogo = "princeton.png", HomeTeamName = "Milford Volleyball", AwayTeamName = "Princeton Volleyball", Location = "5735 Wolfpen Pleasant Hill Rd, Milford, OH 45150", VS = "VS", Note = "Note: Please be at the location half an hour early to do warm up!"},
