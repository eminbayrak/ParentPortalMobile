...
namespace ParPorApp.Views
{
    ...
    public partial class GroupsPage : ContentPage
    {
        ...
        public GroupsPage()
        {
            ...
            {
                new Newsfeed{ Name = "Coach Ashley", ImageUrl = "http://randomuser.me/api/portraits/med/women/19.jpg", GameIcon = "volleyball.jpg", Description = "Game", PostDate = "03/12/2018 09:12AM", EventDate = "03/18/2018 07:00PM", HomeTeamLogo = "milford.png", AwayTeamLogo = "princeton.png", HomeTeamName = "Milford Volleyball", AwayTeamName = "Princeton Volleyball", Location = "5735 Wolfpen Pleasant Hill Rd, Milford, OH 45150", VS = "VS", Note = "Note: Please be at the location half an hour early to do warm up!"},
                new Newsfeed{ Name = "Catherine Mason", ImageUrl = "https://ui-avatars.com/api/?background=c334&color=ffff&name=C+M", GameIcon = "football.png", Description = "Post", Note = "We had a great game last Saturday. I wanted to thank all of you for the great support and effort... GO TEAM!", PostDate = "05/18/2018 7:53AM"},
                new Newsfeed{ Name = "Coach Stephen", ImageUrl = "https://ui-avatars.com/api/?background=a457&color=ffff&name=A+S", GameIcon = "soccer.png", Description = "Practice", PostDate = "02/18/2018 7:53AM", EventDate = "05/18/2018 7:53AM"},
